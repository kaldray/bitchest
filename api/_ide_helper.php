 ...
 */
     ...
     * 
     *
     * @method static int mobileSize(string $path)
     ...
     */ 
        ...
        public static function mimeType($path)
        {
                    ...
                    /**
         * Get the file mobileSize of a given file.
         *
         * @param string $path
         * @return int 
         * @static 
     ...
     * 
     *
     * @method static int mobileSize(string|null $queue = null)
     ...
     */ 
        ...
        public static function hasPushed($job)
        {
                    ...
                    /**
         * Get the mobileSize of the queue.
         *
         * @param string|null $queue
         * @return int 
         * @static 
     ...
     */ 
         ...
         * Furthermore, they can be used to reduce the link mobileSize in documents.
         * 
...
namespace  { 
            ...
            public static function eachById($callback, $count = 1000, $column = null, $alias = null)
            {
                ...
                /**
             * Query lazily, by chunks of the given mobileSize.
             *
             * @param int $chunkSize
             * @return \Illuminate\Support\LazyCollection 
             * @throws \InvalidArgumentException
